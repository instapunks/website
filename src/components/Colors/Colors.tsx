        ...
        <div className="row">
          ...
          <div className="col-12 col-md-6 offset-md-1">
            <div className={styles.colorsSpectrum}>
              <TextBold>
                Instapunk background colors
              </TextBold>

              <div className={styles.colorsSpectrumTextSm}>Followers (millions)</div>

              <img src="./spectrum.svg" alt="Spectrum" className={styles.colorsSpectrumImg} />
              <img src="./spectrum--sm.svg" alt="Spectrum" className={styles.colorsSpectrumImgSm} />

              <div className={styles.colorsSpectrumTextSm}>Wavelenght (nanometers)</div>
